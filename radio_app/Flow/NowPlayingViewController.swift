...
class NowPlayingViewController: UIViewController {
    ...
    var interestViewController: InterestViewController?
...
extension NowPlayingViewController {
    ...
    func openInterests(_ tuneURL: TuneURL.Match) {
        if interestViewController?.presentingViewController != nil {
            //interestViewController?.dismiss(animated: false)
        }
